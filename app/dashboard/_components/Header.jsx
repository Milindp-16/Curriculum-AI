...
const Header = () => {
  ...
  const handleSearch = (e) => {
    if (e.key === 'Enter' && searchInput.trim()) {
      {/* this will direct to the dashboard/explore page and will add whatever you typed as query parameter */ }
      {/* encodeURIComponent is safety feature is a user search something with special characters that can break standard URL
      it safely converts them into URL-friendly code*/}
