...
const TopicDescription = () => {
  ...
  {/* it takes both the field as well as the value and changes the field to that value. rest data remains same using 
      spread operator. it is also dynamic as it can take any field */}
