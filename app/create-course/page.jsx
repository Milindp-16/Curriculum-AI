...
const CreateCourse = () => {
    ...
    //using the context provided by the global context
    const { userCourseInput, setUserCourseInput } = useContext(UserInputContext);
    const { user } = useUser();

    //checker function for disabling the button action
    const checkStatus = () => {
    ...
    const SaveCourseLayoutInDb = async (courseLayout) => {
        ...
        try {
            ...
            // 2. Send the packaged data to your secure Server Action -> save to db + cache invalidation + store in redis cloud
        ...
        <div className='min-h-screen'>
            ...
            <div className='px-6 md:px-20 lg:px-44 mt-10'>
                ...
                <div className='flex justify-between mt-10 mb-10'>
                    {/* if activeIndex is 0 donot disable this button and add onClick to reduce active index by 1 */}
                    <Button
                    ...
                    {/* if activeIndex is 2 donot disable this button and add onClick to increase active index by 1 */}
                    {activeIndex < 2 && (
                        <Button
                    ...
                    {/* if activeIndex < 2 donot disable this button and add onClick to generate final course layout */}
                    {activeIndex == 2 && (
                        <Button
                            disabled={checkStatus()}
