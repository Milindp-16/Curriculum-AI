...
function EditCourseBasicInfo({ courseInfo, setCourseInfo }) {
    ...
    const onUpdateHandler = async () => {
        // 1. Optimistic UI Update -> update the name and description
        ...
        setCourseInfo(updatedCourseInfo);  //set state of the course
        ...
        <>
            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    {/* Backdrop -> clicke outside the dialog box to close the dialog box */}
                    ...
                    <div className="relative w-full max-w-lg bg-[#181818] rounded-xl p-6 shadow-2xl animate-fade-in-up z-10">
                        ...
                        {/* cross button present at the top right to close the dialog box */}
                        <button
                        ...
                        {/* general description about the dialog box */}
